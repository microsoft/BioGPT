...
# News!
* BioGPT-Large model with 1.5B parameters is comming, currently available on PubMedQA task with SOTA perfromance of 81% accuracy. See [Question Answering on PubMedQA](examples/QA-PubMedQA/) for evaluation.
